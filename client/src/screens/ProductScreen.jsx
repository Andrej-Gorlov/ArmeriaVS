  ...
  return (
    <Wrap spacing='30px' justify='center' minHeight='100vh'>
      {loading ? (
        ...
        <Alert status='error'>
          <AlertIcon />
          <AlertTitle>Мы сожалеем!</AlertTitle>
            ...
            <Stack direction={{ base: 'column', lg: 'row' }} align='flex-start'>
              ...
              >
                {product.productIsNew && (
                  <Badge p='2' rounded='md' w='66px' fontSize='0.8em' colorScheme='green'>
                    Новый
                  </Badge>
                )}
                {product.stock === 0 && (
                  ...
                  <Box>
                    ...
                    <Flex>
                      ...
                      <Text fontSize='md' fontWeight='bold' ml='4px'>
                        {product.numberOfReviews} Отзывы
                      </Text>
                    </Flex>
                  </Box>
                  <Text>{product.subtitle}</Text>
                  <Text>{product.description}</Text>
                  <Text fontWeight='bold'>Количество</Text>
                  <Flex
                    w='170px'
                    p='5px'
                    border='1px'
                ...
                {product.reviews.map((review) => (
                  <Box key={review._id}>
                    ...
                    <Text fontSize='sm' color='gray.400'>
                      к {review.name}, {new Date(review.createdAt).toDateString()}
                    </Text>
                  </Box>
                ))}
              </SimpleGrid>
