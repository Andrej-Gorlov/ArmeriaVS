  ...
  return (
    <Skeleton isLoaded={!loading} _hover={{ size: 1.5 }}>
      ...
      >
        ...
        />
        {product.stock < 5 ? (
          <Badge colorScheme='yellow'>Осталось {product.stock}</Badge>
        ) : product.stock < 1 ? (
          <Badge colorScheme='red'>Распроданно</Badge>
        ) : (
          <Badge colorScheme='green'>В наличии</Badge>
        )}
        ...
        <Flex justify='space-between' mt='2'>
          ...
          <IconButton icon={<BiExpand size='20' />} colorScheme='purple' size='sm' />
        </Flex>
      </Box>
    </Skeleton>
  );
